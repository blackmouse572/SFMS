...
>(({ className, variant, fancy, ...props }, forwardedRef) => {
  ...
  return (
    <Context.Provider value={{ variant, fancy } || defaultContextValue}>
      <AccordionPrimitive.Root className={root({ className })} {...props} ref={forwardedRef} />
    </Context.Provider>
  );
});
...
>(({ className, fancy, ...props }, forwardedRef) => {
  ...
  return <AccordionPrimitive.Item className={item({ fancy, className })} {...props} ref={forwardedRef} />;
});
...
>(({ className, children, ...props }, forwardedRef) => {
  ...
  return (
    <AccordionPrimitive.Header className={header({ className })}>
      <AccordionPrimitive.Trigger className={trigger({ className })} {...props} ref={forwardedRef}>
...
>(({ className, children, ...props }, forwardedRef) => {
  ...
  return (
    <AccordionPrimitive.Content className={content({ className })} {...props} ref={forwardedRef}>
      <div>{children}</div>
